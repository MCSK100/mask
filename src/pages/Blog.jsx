...
export default function Blog() {
  return (
    <LegalPageShell
      title="Blog"
      description="Mask blog - Random video chat tips, Omegle alternatives, stranger chat safety."
    >
      <h1 className="text-2xl font-semibold text-white sm:text-3xl">Mask Blog</h1>
      ...
      <section className="space-y-8 text-sm leading-relaxed text-slate-300 sm:text-base">
        <article className="space-y-4">
          ...
          <p>
            Random video chat platforms like Mask connect you with strangers worldwide instantly. While fun and exciting, safety should always come first.
          </p>
          ...
          <p className="text-sm text-slate-400 mt-4 italic">
            Mask is for adults 18+. Parents should monitor children's internet use.
          </p>
        </article>

        <article className="space-y-4">
          <h2 className="text-xl font-semibold text-white border-b border-slate-700 pb-2">Why Mask is the Best Omegle Alternative in 2026</h2>
          <p>
            Omegle was great but has moderation issues. Mask offers modern features:
          </p>
          <ul className="list-disc pl-6 space-y-1 text-slate-300">
        ...
        <article className="space-y-4">
          ...
          <p>
            Get the most out of your Mask experience:
          </p>
          <ul className="list-disc pl-6 space-y-1 text-slate-300">
      ...
      <section className="mt-12 pt-8 border-t border-slate-700">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <Link to="/about" className="block p-4 rounded-xl border border-slate-700/50 hover:border-violet-400/50 hover:bg-slate-900/30 transition">
            <h3 className="font-semibold text-white">About Mask Platform</h3>
